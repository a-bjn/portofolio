        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 text-white">
            <div className="space-y-4">
              <p 
                className={`text-4xl text-gray-400 transition-all duration-1000 ease-out ${
                  isVisible 
              ...
              >
                Hello, I am Andrei Bejan
              </p>
                <h1 
                 className={`text-6xl font-bold leading-tight transition-all duration-1000 ease-out ${
                   isVisible 
                     ? 'opacity-100 translate-y-0' 
                     : 'opacity-0 translate-y-8'
                 }`}
              ...
              <p 
                className={`text-2xl leading-relaxed text-gray-300 font-base max-w-2xl transition-all duration-1000 ease-out ${
                  isVisible 
                    ? 'opacity-100 translate-y-0' 
                    : 'opacity-0 translate-y-8'
                }`}
              ...
              >
                 I am a Computer Science Graduate and I specialize in building web applications using Next.js and Tailwind CSS.
               </p>
            </div>
            <div 
              className={`flex items-center gap-4 pt-4 text-sm transition-all duration-1000 ease-out ${
                isVisible 
                  ? 'opacity-100 translate-y-0' 
                  : 'opacity-0 translate-y-8'
              }`}
          ...
          <div 
            className={`relative w-full max-w-sm mx-auto transition-all duration-1000 ease-out ${
              isVisible 
            ...
            style={{ transitionDelay: '0.4s' }}
          >
            <div className="w-full h-[28rem] flex items-center justify-center relative shadow-[0_25px_50px_-12px_rgba(0,0,0,0.8)] overflow-hidden rounded-3xl animate-float">
              <Image
                src="/poza.jpeg"
