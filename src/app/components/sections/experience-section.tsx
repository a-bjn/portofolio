...
const ExperienceSection: React.FC = () => {
  ...
  // On desktop, always show expanded. On mobile, use expandedCard state
  const allExpanded = !isMobile;
    ...
    <section id="experience" className="relative pt-20 px-6 lg:px-8 overflow-visible">
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className={`text-center mb-10 lg:mb-20 transition-all duration-1000 ease-out ${
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2 lg:mb-6">
            <span className="bg-gradient-to-r from-gray-600 via-gray-400 via-gray-300 to-gray-600 bg-[length:200%_100%] bg-clip-text text-transparent animate-gradient-flow">Work Experience</span>
          </h2>
                    ...
                    <div className="relative p-8">
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 mb-6">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className={`md:hidden p-2 rounded-lg ${experience.iconBg} ${experience.iconColor} group-hover:rotate-180 transition-transform duration-500`}>
