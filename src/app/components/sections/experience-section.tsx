...
const experienceData: Experience[] = [
  {
    ...
    year: "2026",
    description: "Global financial infrastructure and technology group.",
    technologies: ["Spring Boot", "PostgreSQL", "Next.js", "TypeScript", "Tailwind CSS"],
    achievements: [
      "Built a Romanian payroll engine with Spring Boot and PostgreSQL, converting attendance and contracts into gross/net pay, tax deductions, and D112-ready output.",
      "Shipped Next.js workflows for attendance, payroll simulation, and approval, with multi-company access, live salary recalculation, and reusable UI components.",
      "Automated compliance-heavy salary logic (CAS/CASS, deductions, negotiated net, bonuses) so payroll runs from approved pontaj instead of manual spreadsheets.",
    ],
  ...
  },
  {
    ...
    technologies: ["Spring Boot", "PostgreSQL", "React", "Next.js", "SSR", "HTTP-only Cookies", "Stripe"],
    achievements: [
      "Architected backend services with Spring Boot, including authentication, HTTP-only session cookies, and Stripe payment workflows backed by PostgreSQL schemas.",
      "Delivered React and Next.js features with server-side rendering (SSR), client state management, reusable components, and cached API data fetching.",
    ],
  ...
  },
  {
    ...
    technologies: ["React", "TypeScript", "Spring Boot", "REST API"],
    achievements: [
      "Built bug reporting and ticket status tracking on the backend, delivering an MVP adopted by 10+ internal QA testers.",
      "Created React frontend flows with controlled issue submission forms, dynamic ticket filtering, and REST API synchronization.",
    ],
  ...
  },
  {
    ...
    achievements: [
      "Collaborated on an event-scheduling app used by 3+ internal teams to streamline calendar coordination.",
      "Built UI components with Jetpack Compose for calendar scheduling and event management.",
    ],
