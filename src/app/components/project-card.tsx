...
const ProjectCard: React.FC<ProjectProps> = ({ project }) => {
  ...
  return (
    <div 
      className={`group relative bg-zinc-900/50 backdrop-blur-sm border border-zinc-800/50 rounded-2xl hover:bg-zinc-800/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl overflow-hidden flex flex-col ${
    ...
    >
      ...
      <div className="relative z-10 md:p-8 p-4 flex flex-col flex-1">
        ...
        {/* Technologies Used - Expandable on mobile */}
        <div className={`mb-8 flex-grow overflow-hidden transition-all duration-500 ${
          !isMobile || isExpanded ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'
        }`}>
