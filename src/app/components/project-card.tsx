        ...
        case 'nextjs':
          return (
            <Image
              ...
              width={64}
              height={64}
              className="w-16 h-16 flex-shrink-0 drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]"
            />
          );
        case 'tailwind':
        case 'tailwindcss':
        ...
        case 'emailjs':
          return (
            <Image
              ...
              width={64}
              height={64}
              className="w-12 h-12 flex-shrink-0 rounded-lg drop-shadow-[0_0_8px_rgba(255,165,0,0.3)]"
            />
          );
      }
    }
