...
export default function Home() {
  return (
    <main className="relative z-0 pt-20">
      ...
      <div className="absolute inset-0 bg-gradient-to-b md:bg-gradient-to-br from-cyan-400/[0.03] md:from-cyan-400/[0.045] via-black/[0.5] to-transparent pointer-events-none"></div>
